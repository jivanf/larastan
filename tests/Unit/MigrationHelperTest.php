...
class MigrationHelperTest extends PHPStanTestCase
{
    ...
    {
        $migrationHelper = new MigrationHelper($this->parser, ['foobar'], $this->fileHelper, false, $this->modelHelper);
    ...
    {
        $migrationHelper = new MigrationHelper($this->parser, [__DIR__ . '/data/basic_migration'], $this->fileHelper, false, $this->modelHelper);
    ...
    {
        $migrationHelper = new MigrationHelper($this->parser, [__DIR__ . '/data/migrations_with_different_methods'], $this->fileHelper, false, $this->modelHelper);
    ...
    {
        $migrationHelper = new MigrationHelper($this->parser, [__DIR__ . '/data/complex_migrations'], $this->fileHelper, false, $this->modelHelper);
    ...
    public function it_can_read_additional_directories(): void
    {
        ...
        ], $this->fileHelper, false, $this->modelHelper);
    ...
    {
        $migrationHelper = new MigrationHelper($this->parser, [__DIR__ . '/data/migrations_using_soft_deletes'], $this->fileHelper, false, $this->modelHelper);
    ...
    {
        $migrationHelper = new MigrationHelper($this->parser, [__DIR__ . '/data/migrations_using_soft_deletes_tz'], $this->fileHelper, false, $this->modelHelper);
    ...
    {
        $migrationHelper = new MigrationHelper($this->parser, [__DIR__ . '/data/migration_with_default_arguments'], $this->fileHelper, false, $this->modelHelper);
    ...
    {
        $migrationHelper = new MigrationHelper($this->parser, [__DIR__ . '/data/migration_with_schema_connection'], $this->fileHelper, false, $this->modelHelper);
    ...
    public function it_can_disable_migration_scanning(): void
    {
        $migrationHelper = new MigrationHelper($this->parser, [
            __DIR__ . '/data/basic_migration',
            __DIR__ . '/data/additional_migrations',
        ], $this->fileHelper, true, $this->modelHelper);
    ...
    {
        $migrationHelper = new MigrationHelper($this->parser, [__DIR__ . '/data/migrations_using_nullable'], $this->fileHelper, false, $this->modelHelper);
    ...
    {
        $migrationHelper = new MigrationHelper($this->parser, [__DIR__ . '/data/conditional_migrations'], $this->fileHelper, false, $this->modelHelper);
